  ...
  return (
    <div className="relative w-full aspect-square max-w-[500px] mx-auto flex items-center justify-center group cursor-pointer mt-10 md:mt-0">
      ...
      <div className="absolute inset-4 sm:inset-0 border-[0.5px] border-gray-200 rounded-full animate-[spin_25s_linear_infinite] group-hover:[animation-play-state:paused]">
        ...
        {/* Facebook */}
        <a 
          href="https://www.facebook.com/profile.php?id=61582156372278"
          target="_blank"
          rel="noopener noreferrer"
          className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-14 h-14 bg-[#1877F2] rounded-2xl shadow-xl flex items-center justify-center text-white animate-[spin_25s_linear_infinite] border-2 border-white hover:scale-110 transition-transform cursor-pointer pointer-events-auto"
        ...
        {/* LinkedIn */}
        <a 
          href="https://www.linkedin.com/company/adods/"
          target="_blank"
          rel="noopener noreferrer"
          className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-14 h-14 bg-[#0A66C2] rounded-2xl shadow-xl flex items-center justify-center text-white animate-[spin_25s_linear_infinite] border-2 border-white hover:scale-110 transition-transform cursor-pointer pointer-events-auto"
          style={{ animationDirection: "reverse" }}
        >
          <svg className="w-7 h-7 fill-current" viewBox="0 0 24 24">
      ...
      <div className="absolute inset-20 sm:inset-16 border-[0.5px] border-gray-200 rounded-full animate-[spin_18s_linear_infinite_reverse] group-hover:[animation-play-state:paused]">
        ...
        {/* Instagram */}
        <a 
          href="https://www.instagram.com/adods.in/?hl=en"
          target="_blank"
          rel="noopener noreferrer"
          className="absolute left-0 top-1/2 -translate-x-1/2 -translate-y-1/2 w-14 h-14 bg-gradient-to-tr from-[#f09433] via-[#e6683c] to-[#bc1888] rounded-2xl shadow-xl flex items-center justify-center text-white animate-[spin_18s_linear_infinite] border-2 border-white hover:scale-110 transition-transform cursor-pointer pointer-events-auto"
        >
        ...
        {/* WhatsApp */}
        <a 
          href="https://wa.me/919207336182"
          target="_blank"
          rel="noopener noreferrer"
          className="absolute right-0 top-1/2 translate-x-1/2 -translate-y-1/2 w-14 h-14 bg-[#25D366] rounded-2xl shadow-xl flex items-center justify-center text-white animate-[spin_18s_linear_infinite] border-2 border-white hover:scale-110 transition-transform cursor-pointer pointer-events-auto"
        >
          <svg className="w-8 h-8 fill-current" viewBox="0 0 24 24">
