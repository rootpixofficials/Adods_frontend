...
const ProcessCard = ({ number, title, desc, rotate }: { number: string; title: string; desc: string; rotate: string }) => (
  <div className={`relative w-[280px] md:w-[320px] bg-white rounded-[32px] shadow-[0_20px_50px_rgba(0,0,0,0.08)] p-8 ${rotate} transition-transform duration-500 hover:-translate-y-3 hover:shadow-[0_25px_60px_rgba(0,0,0,0.12)] z-20 inline-block`}>
    ...
    <section className="bg-white py-24 md:py-32 overflow-hidden relative">
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12 relative z-20">
          ...
          <div className="w-full lg:w-auto flex justify-center lg:justify-end lg:pr-10 relative">
            <ProcessCard number="01" title="Define" desc={dummyText} rotate="rotate-[6deg]" />
        ...
        {/* Row 2: Card 02 */}
        <div className="w-full flex justify-center lg:justify-start lg:pl-[10%] relative z-20 mt-12 lg:mt-0">
          <div className="relative inline-block">
            <ProcessCard number="02" title="Design" desc={dummyText} rotate="-rotate-[5deg]" />
        ...
        <div className="w-full flex justify-center lg:justify-end lg:pr-[10%] relative z-20 mt-12 lg:mt-0">
          <div className="relative inline-block">
            <ProcessCard number="03" title="Build" desc={dummyText} rotate="rotate-[3deg]" />
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-end gap-10 lg:gap-0 mt-12 lg:mt-0 relative z-20">
          <div className="w-full lg:w-auto flex justify-center lg:justify-start lg:pl-[5%]">
            <ProcessCard number="04" title="Launch" desc={dummyText} rotate="-rotate-[4deg]" />
          </div>

          <div className="w-full lg:w-auto flex justify-center lg:justify-end lg:pr-10">
