              ...
              <AnimatedSection direction="up" delay={0.1}>
                ...
                <div className="space-y-10">
                  <div className="flex flex-col">
                    ...
                    <a href="mailto:addodsproduction@gmail.com" className="text-2xl lg:text-[1.3rem] font-semibold hover:text-blue-600 transition-colors">addodsproduction@gmail.com</a>
                  </div>
                  <div className="flex flex-col">
                    <h4 className="text-sm uppercase tracking-widest text-gray-400 font-bold mb-2">Join the team</h4>
                    <a href="mailto:adodsofficial@gmail.com" className="text-2xl lg:text-[1.3rem] font-semibold hover:text-blue-600 transition-colors">adodsofficial@gmail.com</a>
                  </div>
                  <div className="flex flex-col">
                    <h4 className="text-sm uppercase tracking-widest text-gray-400 font-bold mb-2">Call Us</h4>
                    <a href="tel:+919207336182" className="text-2xl font-semibold hover:text-blue-600 transition-colors">+91 92073 36182</a>
                  </div>
                  <div className="flex flex-col">
