...
export default function WhatWeDo() {
  ...
  return (
    <div className="min-h-screen bg-transparent text-white">
      {/* Hero */}
      <AnimatedSection className="relative w-full pt-44 pb-20 px-6 bg-transparent text-white overflow-hidden" direction="none" delay={0.1}>
      ...
      <div className="py-24 px-6 bg-transparent text-white">
        <div className="container mx-auto max-w-6xl space-y-24">
           {services.map((service, idx) => (
             <AnimatedSection key={idx} direction="up" delay={0.2} className={`flex flex-col lg:flex-row gap-12 lg:gap-20 items-center ${idx % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}>
                ...
                {/* Visual Placeholder */}
                <div className="w-full lg:w-5/12 aspect-[4/3] relative rounded-[3rem] overflow-hidden bg-white/5 backdrop-blur-md shadow-lg border border-white/10 group">
                  <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent opacity-90 group-hover:opacity-100 transition-opacity duration-300"></div>
                ...
                <div className="w-full lg:w-7/12 flex flex-col">
                  <div className="inline-flex items-center space-x-3 mb-6">
                    ...
                    <span className="text-sm font-bold uppercase tracking-widest text-gray-300">Core Expertise</span>
                  </div>
      ...
      {/* Embedded Banner */}
      <AnimatedSection className="py-24 px-6 bg-transparent" direction="up" delay={0.2}>
        <div className="container mx-auto max-w-5xl text-center items-center justify-center flex flex-col">
          ...
          <p className="text-gray-300 mb-8 max-w-xl text-lg">Every business is unique. We provide free consultations to audit your current digital state and recommend a custom roadmap tailored just for you.</p>
        </div>
      </AnimatedSection>
